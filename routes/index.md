...
- чт [**Древник**]({{ site.baseurl }}/drvenik/) → [**Маслиница**]({{ site.baseurl }}/maslinica/) *(~18 NM)*  
- пт [**Маслиница**]({{ site.baseurl }}/maslinica/) → [**Сплит**]({{ site.baseurl }}/split/) *(~18 NM)*  

![На водопады](balanced.png)
...
- чт [**Старый Град**] → [**Бол**] *(~18 NM)*  
- пт [**Бол**] → [**Сплит**]({{ site.baseurl }}/split/) *(~32 NM)*  
